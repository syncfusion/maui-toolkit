...
namespace Syncfusion.Maui.Toolkit.SegmentedControl
{
	...
	/// </summary>
	internal partial class KeyNavigationView : SfDrawableView
	{
		#region Fields
		...
		protected override void OnDraw(ICanvas canvas, RectF dirtyRect)
		{
			...
			AdjustCornerRadiiForBorder(out var cornerRadiusTopLeft, out var cornerRadiusTopRight, out var cornerRadiusBottomRight, out var cornerRadiusBottomLeft);
