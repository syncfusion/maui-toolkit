...
namespace Syncfusion.Maui.Toolkit.SegmentedControl
{
	...
	/// </summary>
	internal partial class SelectionView : SfDrawableView
	{
		#region Fields
		...
		void DrawRoundedRectangle(ICanvas canvas, RectF dirtyRect)
		{
			...
			{
				Left = SelectionView.GetLeftBorderPosition(dirtyRect, selectionStrokeThickness),
				Top = SelectionView.GetTopBorderPosition(dirtyRect, selectionStrokeThickness),
				Right = SelectionView.GetRightBorderPosition(dirtyRect, strokeRadius),
				Bottom = SelectionView.GetBottomBorderPosition(dirtyRect, strokeRadius)
			};
		...
		void DrawTopBorder(ICanvas canvas, RectF dirtyRect)
		{
			...
			// Get the stroke thickness and background color.
			_ = (float)_itemInfo.StrokeThickness;
			float selectionStrokeThickness = (float)_itemInfo.SelectionIndicatorSettings.StrokeThickness;
		...
		static float GetTopBorderPosition(RectF dirtyRect, float strokeThickness)
		{
		...
		static float GetBottomBorderPosition(RectF dirtyRect, float strokeThickness)
		{
			// The position for drawing a bottom border on a canvas.
		...
		static float GetLeftBorderPosition(RectF dirtyRect, float strokeThickness)
		{
		...
		static float GetRightBorderPosition(RectF dirtyRect, float strokeThickness)
		{
