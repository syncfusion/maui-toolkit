...
namespace Syncfusion.Maui.Toolkit.SegmentedControl
{
	...
	/// </summary>
	internal class SegmentItemView : SfContentView, ITouchListener, ITapGestureListener
    {
        #region Fields
        ...
        /// </summary>
        internal SfSegmentItem SegmentItem;
        ...
        internal void ClearSelection()
        {
            ...
            RemoveEffects();
            IsSelected = false;
            _selectionView.UpdateVisualState(IsSelected, false);
            InvalidateDrawable();
        }
        ...
        {
            if (SegmentItem == null || itemInfo?.SegmentTemplate != null)
            {
                return;
            }
            ...
            ImageSource imageSource = SegmentItem.ImageSource;
            if (imageSource == null)
            {
        ...
        void DrawRoundedRectangle(ICanvas canvas, RectF dirtyRect)
        {
            ...
            bool isEnabled = SegmentViewHelper.GetItemEnabled(itemInfo, SegmentItem);
            Brush background = isEnabled ? SegmentViewHelper.GetSegmentBackground(itemInfo, SegmentItem) : itemInfo.DisabledSegmentBackground;
        ...
        void DrawTextWithImage(ICanvas canvas, RectF dirtyRect)
        {
            ...
            ImageSource image = SegmentItem.ImageSource;
            SegmentTextStyle textStyle = SegmentViewHelper.GetClonedSegmentTextStyle(itemInfo, SegmentItem);
            bool isEnabled = SegmentViewHelper.GetItemEnabled(itemInfo, SegmentItem);
            if (isEnabled && IsSelected)
            {
                textStyle.TextColor = SegmentViewHelper.GetSelectedSegmentForeground(itemInfo, SegmentItem);
            }
            else
            {
            ...
            if (image != null)
            {
                ...
                textRect = GetTextRect(dirtyRect, imageRect, padding);
            }
        ...
        Rect GetTextRect(RectF dirtyRect, RectF imageRect, double padding)
        {
        ...
        {
            double imageSize = SegmentItem.ImageSize;
            SegmentTextStyle textStyle = new SegmentTextStyle();
            if (itemInfo != null)
            {
                textStyle = SegmentViewHelper.GetSegmentTextStyle(itemInfo, SegmentItem);
            }

            Size textSize = SegmentItemViewHelper.GetTextSize(SegmentItem.Text, textStyle);
            ...
            double imageXPos = string.IsNullOrEmpty(SegmentItem.Text) ? availedSize : availedSize - padding;
        ...
        {
            if (SegmentItem == null || SegmentItem.ImageSource == null ||
            ...
            {
                Source = SegmentItem.ImageSource,
#if !ANDROID
                HorizontalOptions = LayoutOptions.Center,
                VerticalOptions = LayoutOptions.Center,
#endif
#if MACCATALYST || IOS
                WidthRequest = SegmentItem.ImageSize,
                HeightRequest = SegmentItem.ImageSize,
#endif
            };
        ...
        void InitializeSelectionView()
        {
            ...
            if (SegmentItem == null || itemInfo == null || !IsEnabled)
            {
                return;
            }

            _selectionView = new SelectionView(SegmentItem, itemInfo);
        ...
        {
            if (itemInfo == null || SegmentItem == null)
            {
                return;
            }

            IsEnabled = SegmentViewHelper.GetItemEnabled(itemInfo, SegmentItem);
        }
        ...
        {
            if (SegmentItem == null || itemInfo == null || itemInfo.Items == null)
            {
                return;
            }

            int index = itemInfo.Items.IndexOf(SegmentItem);
            if (index == -1)
            {
                index = 0;
            }
        ...
        void UpdateMouseOver(bool isMouseOver)
        {
            ...
            _selectionView?.UpdateVisualState(IsSelected, isMouseOver);
            InvalidateDrawable();
            if (isMouseOver)
            {
        ...
        Brush GetBackgroundValue()
        {
            ...
            if (IsSelected)
            {
                background = _isMouseOver ? SegmentViewHelper.GetSelectedSegmentHoveredBackground(itemInfo, SegmentItem)
                    : SegmentViewHelper.GetSelectedSegmentBackground(itemInfo, SegmentItem);
            }
        ...
        void CreateSegmentItemTemplateView()
        {
            ...
            {
                DataTemplate template = templateSelector.SelectTemplate(SegmentItem, this);
                _itemTemplateView = SegmentItemViewHelper.CreateTemplateView(template, SegmentItem, isRTL);
            }
            else
            {
                _itemTemplateView = SegmentItemViewHelper.CreateTemplateView(segmentTemplate, SegmentItem, isRTL);
            }

            if (_itemTemplateView != null)
            {
                _itemTemplateView.IsEnabled = SegmentViewHelper.GetItemEnabled(itemInfo, SegmentItem);
        ...
        protected override List<SemanticsNode>? GetSemanticsNodesCore(double width, double height)
        {
            ...
            string text = SegmentItem.Text;
            if (!SegmentItem.IsEnabled || (itemInfo != null && !itemInfo.IsEnabled))
            {
                semanticsNode.Text = text + SfSegmentedResources.GetLocalizedString("Disabled");
            }
            else
            {
                semanticsNode.Text = IsSelected ? text + SfSegmentedResources.GetLocalizedString("Selected") : text;
            }

            return new List<SemanticsNode>() { semanticsNode };
        }
        ...
        protected override Size MeasureContent(double widthConstraint, double heightConstraint)
        {
            foreach (var child in Children)
            {
                if (child is Image)
                {
                    double iconSize = SegmentItem.ImageSize;
