...
namespace Syncfusion.Maui.Toolkit.SegmentedControl
{
    ...
    public partial class SfSegmentedControl : SfView, ISegmentItemInfo, IKeyboardListener, IParentThemeElement
    {
        ...
        /// </summary>
        ObservableCollection<SfSegmentItem>? ISegmentInfo.Items => Items;
        ...
        /// </summary>
        internal ObservableCollection<SfSegmentItem>? Items;
        ...
        {
            if (_scrollView == null || Items == null || index < 0 || index >= Items.Count)
            {
                return;
            }
        ...
        void WireEvents()
        {
            ...
            var segmentItems = ItemsSource as IEnumerable;
            if (segmentItems != null)
            {
                var segmentItemsChanged = segmentItems as INotifyCollectionChanged;
                if (segmentItemsChanged != null)
                {
        ...
        void OnSegmentItemsCollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Replace:
                    ...
                    ObservableCollection<SfSegmentItem>? segmentItems = ItemsSource as ObservableCollection<SfSegmentItem>;
                    if (segmentItems != null)
                    {
        ...
        void MoveSegmentItem(int oldIndex, int newIndex)
        {
            ...
            if (Items == null || oldIndex < 0 || oldIndex >= Items.Count || newIndex < 0 || newIndex >= Items.Count)
            {
                return;
            }
        ...
        void AddSegmentItems(NotifyCollectionChangedEventArgs e)
        {
            ...
            else if (itemsSource is IEnumerable<FileImageSource> images)
            {
                ...
                if (e.NewStartingIndex >= 0 && e.NewStartingIndex < images.Count())
                {
                    ...
                    // Insert the item at the specified index
                    Items.Insert(e.NewStartingIndex, segmentItem);
                }
            }
            else
            {
        ...
        {
            if (_scrollView == null || Items == null || !isAutoScrollToSelectedIndex)
            {
                return;
            }
            ...
            foreach (SfSegmentItem segmentItem in Items)
            {
                if (segmentItem == null)
                {
                    continue;
        ...
        void UpdateScrollOnKeyNavigation(SegmentItemView? focusedView)
        {
            ...
            double focusedViewRight = focusedView.Bounds.Right;
            ...
            _keyNavigationView?.UpdateNavigationView(focusedView.SegmentItem, rect, isFirstViewFocused, isLastViewFocused);
        }
        ...
        void ISegmentItemInfo.UpdateScrollOnKeyNavigation(int index)
        {
            ...
            _keyNavigationView?.UpdateNavigationView(focusedView.SegmentItem, focusedView.Bounds);
