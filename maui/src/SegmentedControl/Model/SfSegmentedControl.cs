...
namespace Syncfusion.Maui.Toolkit.SegmentedControl
{
    ...
    public partial class SfSegmentedControl
    {
        ...
        static void OnItemsSourceChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            var oldSegmentItems = oldValue as IEnumerable;
            if (oldSegmentItems != null)
            {
                var oldSegmentItemsChanged = oldSegmentItems as INotifyCollectionChanged;
                if (oldSegmentItemsChanged != null)
                {
                    oldSegmentItemsChanged.CollectionChanged -= segmentedControl.OnSegmentItemsCollectionChanged;
                }
            }

            var newSegmentItems = newValue as IEnumerable;
            if (newSegmentItems != null)
            {
                var newSegmentItemsChanged = newSegmentItems as INotifyCollectionChanged;
                if (newSegmentItemsChanged != null)
                {
        ...
        {
            SfSegmentedControl segmentedControl = (SfSegmentedControl)bindable;
            if (segmentedControl == null || segmentedControl._segmentLayout == null || segmentedControl.Items == null)
            {
                return;
            }
            ...
            SfSegmentItem? oldSelectedItem = oldIndex >= 0 ? segmentedControl.Items.ElementAtOrDefault(oldIndex) : null;
            SfSegmentItem? newSelectedItem = newIndex >= 0 ? segmentedControl.Items.ElementAtOrDefault(newIndex) : null;
        ...
        static void OnSelectionSettingsChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            SelectionIndicatorSettings? oldSettings = oldValue as SelectionIndicatorSettings;
            if (oldSettings != null)
            {
                oldSettings.PropertyChanged -= segmentedControl.OnSelectionIndicatorSettingsPropertyChanged;
            }

            SelectionIndicatorSettings? newSettings = newValue as SelectionIndicatorSettings;
            if (newSettings != null)
            {
        ...
        static void OnTextStyleChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            SegmentTextStyle? oldStyle = oldValue as SegmentTextStyle;
            if (oldStyle != null)
            {
                oldStyle.PropertyChanged -= segmentedControl.OnTextStylePropertyChanged;
            }

            SegmentTextStyle? newStyle = newValue as SegmentTextStyle;
            if (newStyle != null)
            {
