...
namespace Syncfusion.Maui.Toolkit.Carousel
{
	...
	/// ***
	/// </example>
	public class SfCarousel : View, ICarousel
    {
		#region Fields
        ...
        {
            get { return (bool)this.GetValue(AllowLoadMoreProperty); }
            set { this.SetValue(AllowLoadMoreProperty, value); }
        }
        ...
        {
            get { return (bool)this.GetValue(EnableVirtualizationProperty); }
            set { this.SetValue(EnableVirtualizationProperty, value); }
        }
        ...
        {
            get { return (int)this.GetValue(LoadMoreItemsCountProperty); }
            set { this.SetValue(LoadMoreItemsCountProperty, value); }
        }
        ...
        {
            get { return (View)this.GetValue(LoadMoreViewProperty); }
            set { this.SetValue(LoadMoreViewProperty, value); }
		}
        ...
        {
            get { return (ViewMode)this.GetValue(ViewModeProperty); }
        ...
        {
            get { return (int)this.GetValue(ItemSpacingProperty); }
        ...
        {
            get { return (int)this.GetValue(RotationAngleProperty); }
        ...
        public float Offset
        {
            get { return (float)this.GetValue(OffsetProperty); }
        ...
        {
            get { return (float)this.GetValue(ScaleOffsetProperty); }
            set { this.SetValue(ScaleOffsetProperty, value); }
        }
        ...
        {
            get { return (int)this.GetValue(SelectedItemOffsetProperty); }
            set { this.SetValue(SelectedItemOffsetProperty, value); }
        }
        ...
        {
            get { return (bool)this.GetValue(EnableInteractionProperty); }
            set { this.SetValue(EnableInteractionProperty, value); }
        }
        ...
        {
            get { return (SwipeMovementMode)this.GetValue(SwipeMovementModeProperty); }
            set { this.SetValue(SwipeMovementModeProperty, value); }
        }
		#endregion
        ...
        protected override void OnPropertyChanged([CallerMemberName] string? propertyName = null)
        {
            ...
            {
                if (this.Handler != null && this.Handler.PlatformView is PlatformCarousel platformCarousel)
                {
                    platformCarousel.IsEnabled = this.IsEnabled;
                }
            }
...
#else
            if (this.Handler != null && this.Handler.PlatformView is PlatformCarousel)
            {
                double x = ((PlatformCarousel)this.Handler.PlatformView).Frame.X;
                double y = ((PlatformCarousel)this.Handler.PlatformView).Frame.Y;

                if (this.HeightRequest <= 0 || this.WidthRequest <= 0)
                {
                    ((PlatformCarousel)this.Handler.PlatformView).Frame = new CoreGraphics.CGRect(x, y, width, height);
                }
            }
#endif
        }
        ...
        private Size MeasureOverrideForIOS(double widthConstraint, double heightConstraint)
        {
            ...
            {
                DesiredSize = MeasureForStackLayout(stackLayout, widthConstraint, heightConstraint, minWidth, minHeight);
            }
            else if (Parent is ScrollView scrollView)
            {
                DesiredSize = MeasureForScrollView(scrollView, widthConstraint, heightConstraint, minWidth, minHeight);
            }
        ...
        {
            this.minHeight = ItemHeight;
            this.minWidth = ItemWidth;

            widthConstraint = double.IsNaN(widthConstraint) || double.IsInfinity(widthConstraint) ? minWidth : widthConstraint;
            heightConstraint = double.IsNaN(heightConstraint) || double.IsInfinity(heightConstraint) ? minHeight : heightConstraint;

            if (HeightRequest > 0) heightConstraint = HeightRequest;
            if (WidthRequest > 0) widthConstraint = WidthRequest;
        }
        ...
        Size MeasureForHorizontalLayout(double widthConstraint, double heightConstraint)
        {
            return new Size(WidthRequest >= 0 ? WidthRequest : ItemWidth, HeightRequest >= 0 && WidthRequest >= 0 ? HeightRequest : heightConstraint);
        }
        ...
        {
            return new Size(HeightRequest >= 0 && WidthRequest >= 0 ? WidthRequest : widthConstraint, HeightRequest >= 0 ? HeightRequest : this.ItemHeight);
        }
#endif
        ...
        {
            if (this.ItemsSource is INotifyCollectionChanged itemsource)
            {
        ...
        {
            this.OnPropertyChanged(nameof(ItemsSource));
        }
        ...
        {
            this.SwipeStarted?.Invoke(this, args);
        }
        ...
        {
            this.SwipeEnded?.Invoke(this, args);
        }
		#endregion
		#endregion
	}
