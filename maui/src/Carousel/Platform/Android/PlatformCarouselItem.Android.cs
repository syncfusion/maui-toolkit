...
namespace Syncfusion.Maui.Toolkit.Carousel
{
	...
	public partial class PlatformCarouselItem : FrameLayout
	{
		...
		/// The context.
		/// </summary>
		private readonly Context? _contextCarouselItem;
		...
		{
			PlatformCarouselItem.RemoveViewFromParent(view);
			if (ParentItem != null)
			{
		...
		static void SetImageBitmap(ImageView imageView, Bitmap originalBitmap)
		{
		...
		bool IsLastItemAndLoadMoreAllowed()
		{
			return ParentItem != null && ParentItem.TempDataSource != null &&
				   ...
				   ParentItem._tempItemsSource != null && ParentItem.ItemsSourceCollection != null &&
