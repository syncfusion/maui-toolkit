...
namespace Syncfusion.Maui.Toolkit.Carousel
{
	...
	internal class LinearModeCollectionLayout : UICollectionViewDelegateFlowLayout
	{
		...
		/// The carousel field.
		/// </summary>
		private readonly PlatformCarousel _carousel;
	...
	internal class LinearModeCollectionSource : UICollectionViewDataSource
	{
		...
		{
			LinearModeCollectionSource.ClearExistingSubviews(cell);
		...
		UICollectionViewCell ConfigureRegularCell(UICollectionViewCell cell, UICollectionView collectionView, NSIndexPath indexPath)
		{
			...
			PlatformCarouselItem carouselItem = _carousel.LinearDataSource != null ? _carousel.LinearDataSource.GetItem<PlatformCarouselItem>((nuint)indexPath.Row) : [];
		...
		/// </summary>
		static void ClearExistingSubviews(UICollectionViewCell cell)
		{
	...
	internal class SfLinearMode : UIView
	{
		...
		{
			if (_carousel == null || _viewCollection == null)
			{
				return;
			}
