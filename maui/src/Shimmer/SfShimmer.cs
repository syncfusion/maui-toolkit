...
namespace Syncfusion.Maui.Toolkit.Shimmer
{
    ...
    /// </summary>
    public class SfShimmer : SfContentView, IShimmer, IParentThemeElement
    {
        ...
        {
            var shimmer = bindable as SfShimmer;
            if (shimmer == null)
            {
                return;
            }
        ...
        {
            var shimmer = bindable as SfShimmer;
            if (shimmer == null || shimmer.ShimmerDrawable == null || shimmer._availableSize == Size.Zero)
            {
                return;
            }
        ...
        {
            var shimmer = bindable as SfShimmer;
            if (shimmer == null || shimmer.CustomView != null || shimmer.ShimmerDrawable == null || shimmer._availableSize == Size.Zero)
            {
                return;
            }
