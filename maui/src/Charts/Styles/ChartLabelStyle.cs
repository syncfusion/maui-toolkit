...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public class ChartLabelStyle : Element, ITextElement, IThemeElement
    {
        ...
        static void OnBackgroundColorChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (style != null)
            {
                ...
                style.IsBackgroundColorUpdated = color != null;
            }
        }
    ...
    internal class ChartThemeLegendLabelStyle : ChartLegendLabelStyle, IParentThemeElement
    {
        #region Constructor
        ...
        void SetLegendThemeValue(ChartBase chart)
        {
            if (chart is SfCartesianChart)
            {
                ...
                this.SetDynamicResource(DisableBrushProperty, "SfCartesianChartLegendDisableBrush");
            }
            ...
            if (chart is SfCircularChart)
            {
                ...
                this.SetDynamicResource(DisableBrushProperty, "SfCircularChartLegendDisableBrush");
            }
            ...
            if (chart is SfPyramidChart)
            {
                ...
                this.SetDynamicResource(DisableBrushProperty, "SfPyramidChartLegendDisableBrush");
            }
            ...
            if (chart is SfFunnelChart)
            {
                ...
                this.SetDynamicResource(DisableBrushProperty, "SfFunnelChartLegendDisableBrush");
            }
            ...
            if (chart is SfPolarChart)
            {
                ...
                this.SetDynamicResource(DisableBrushProperty, "SfPolarChartLegendDisableBrush");
            }
        }
