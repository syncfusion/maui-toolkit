...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public abstract class ChartPlotBand : Element
    {
        ...
        protected override void OnParentSet()
        {
            ...
            {
                _actualLabelStyle.Parent = this.Parent;
            }   
        }
        ...
        {
            float x = (float)_actualLabelStyle.OffsetX, y = (float)_actualLabelStyle.OffsetY;
        ...
        static void OnLabelStylePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is ChartPlotBand plotBand)
            {
                ...
                else
                {
                    ...
                    plotBand._actualLabelStyle.Parent = plotBand.Parent;
        ...
        {
            switch (_actualLabelStyle.HorizontalTextAlignment)
            {
        ...
        {
            switch (_actualLabelStyle.VerticalTextAlignment)
            {
                case ChartLabelAlignment.Center:
