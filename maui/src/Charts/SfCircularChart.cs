...
namespace Syncfusion.Maui.Toolkit.Charts
{
    ...
    public class SfCircularChart : ChartBase, ITouchListener, ITapGestureListener, IParentThemeElement
    {
        ...
        public SfCircularChart()
        {
            ...
            this.SetDynamicResource(TooltipBackgroundProperty, "SfCircularChartTooltipBackground");
            this.SetDynamicResource(TooltipTextColorProperty, "SfCircularChartTooltipTextColor");
            this.SetDynamicResource(TooltipFontSizeProperty, "SfCircularChartTooltipTextFontSize");
