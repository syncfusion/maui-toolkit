...
namespace Syncfusion.Maui.Toolkit.Charts
{
    internal class CartesianAxisLayout : AbsoluteLayout, IAxisLayout
    {
        ...
        void Init()
        {
            _leftSizes = new List<double>();
            _topSizes = new List<double>();
            _rightSizes = new List<double>();
            _bottomSizes = new List<double>();
        }
        ...
        {
            VerticalAxes = _area.IsTransposed ? _area.XAxes : new ObservableCollection<ChartAxis>(from axis in _area.YAxes select axis);
            HorizontalAxes = _area.IsTransposed ? new ObservableCollection<ChartAxis>(from axis in _area.YAxes select axis) : _area.XAxes;
        ...
        {
            var plotArea = _area.PlotArea as ChartPlotArea;
