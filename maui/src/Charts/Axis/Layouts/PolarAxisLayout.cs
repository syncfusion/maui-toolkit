...
namespace Syncfusion.Maui.Toolkit.Charts
{
	internal class PolarAxisLayoutView : SfDrawableView
    {
        ...
        SizeF ComputeMaximumLabelSize()
        {
            ...
            ChartAxis primaryAxis = _chartArea.PolarChart.PrimaryAxis;
            if (primaryAxis == null)
            {
                return SizeF.Zero;
            }
            ...
            for (int i = 0; i < primaryAxis.VisibleLabels.Count; i++)
            {
                ...
                ChartLineStyle lineStyle = _chartArea.PolarChart.PrimaryAxis.AxisLineStyle;
        ...
        void UpdateActualAxis(ReadOnlyObservableCollection<ChartSeries> visibleSeries)
        {
            foreach (PolarSeries series in visibleSeries)
            {
                if (series != null)
                {
                    ...
                    {
                        var axis = _chartArea.PolarChart.PrimaryAxis;
                    ...
                    {
                        var axis = _chartArea.PolarChart.SecondaryAxis;
        ...
        void DrawLabelBackground(ICanvas canvas, Rect rect, ChartAxisLabelStyle labelStyle)
        {
        ...
        {
            if (_xAxis == null || _yAxis == null) return default(PointF);
            ...
            float labelAngle;
            var angel = _chartArea.PolarChart.PolarStartAngle;
        ...
        {
            if (_yAxis == null || totalSpokes == 0) return;
            float angle = 360 / totalSpokes;
