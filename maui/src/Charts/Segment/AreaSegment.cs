...
namespace Syncfusion.Maui.Toolkit.Charts
{
    ...
    /// </summary>
    public class AreaSegment : CartesianSegment, IMarkerDependentSegment
    {
        #region Properties
        ...
        void DrawPath(ICanvas canvas, List<float>? fillPoints, List<float>? strokePoints)
        {
            ...
            if (fillPoints != null)
            {
                DrawSegment(canvas, ref path, fillPoints, animationValue, isDynamicAnimation, PreviousFillPoints);
            ...
            {
                path = new PathF();
                DrawSegment(canvas, ref path, strokePoints, animationValue, isDynamicAnimation, PreviousStrokePoints);
        ...
        void DrawSegment(ICanvas canvas, ref PathF path, List<float> fillPoints, float animationValue, bool isDynamicAnimation, List<float>? previousFillPoints)
        {
