    ...
    public class PolarAreaSegment : ChartSegment, IMarkerDependentSegment
    {
        ...
        internal override void OnDataLabelLayout()
        {
            if (Series is PolarAreaSeries series && series != null && series.LabelTemplate != null)
            {
                ...
                if (dataLabeSettings == null || xValues == null || series.YValues == null) return;
        ...
        void DrawPath(ICanvas canvas, List<float>? fillPoints, List<float>? strokePoints)
        {
            ...
            if (fillPoints != null)
            {
                DrawAreaPath(ref _path, fillPoints);
            ...
            if (HasStroke && strokePoints != null)
            {
                ...
                DrawAreaPath(ref _path, strokePoints);
        ...
        List<float> GenerateInteriorPoints(float animationValue)
        {
            ...
            if (Series is not PolarSeries series) return fillPoints;
        ...
        List<float> GenerateStrokePoints(float animationValue)
        {
            ...
            if (Series is not PolarSeries series) return strokePoints;
        ...
        void DrawAreaPath(ref PathF path, List<float> points)
        {
