namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public abstract class CartesianSegment : ChartSegment
	{
		...
		internal static float GetDynamicAnimationValue(float animationValue, float value, float oldValue, float newValue)
		{
		...
		{
			if (Series is not XYDataSeries xyDataSeries || xyDataSeries.ChartArea == null || !xyDataSeries.ShowDataLabels || xyDataSeries.DataLabelSettings == null)
			{
				return;
			}
