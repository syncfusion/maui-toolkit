...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public partial class HorizontalLineAnnotation : LineAnnotation
	{
		...
		public HorizontalLineAnnotation()
		{
			...
			_annotationLabelStyle.HorizontalTextAlignment = ChartLabelAlignment.End;
		...
		internal override void OnLayout(SfCartesianChart chart, ChartAxis xAxis, ChartAxis yAxis, double x1, double y1)
		{
			...
			if (CoordinateUnit == ChartCoordinateUnit.Axis)
			{
				...
				{
					_isVertical = true;
					(x1, _) = TransformCoordinates(chart, xAxis, yAxis, x1, y1);
					(x2, _) = TransformCoordinates(chart, xAxis, yAxis, x2, y2);
		...
		{
			float marginTop = (float)_axisLabelStyle.Margin.Top;
