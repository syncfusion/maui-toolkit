...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public class VerticalLineAnnotation : LineAnnotation
    {
        ...
        public VerticalLineAnnotation()
        {
            ...
            annotationLabelStyle.HorizontalTextAlignment = ChartLabelAlignment.Start;
        ...
        void CalculateVerticalAxisLabelPosition(ChartAxis xAxis, Rect actualSeriesClipRect)
        {
            ...
            string labelFormat = !string.IsNullOrEmpty(axisLabelStyle.LabelFormat) ? 
                axisLabelStyle.LabelFormat : xAxis is DateTimeAxis ? 
                "MM-dd-yyyy" : "##.##";
