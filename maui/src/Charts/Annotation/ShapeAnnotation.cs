...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public abstract class ShapeAnnotation : ChartAnnotation, IThemeElement
    {
        ...
        {
            annotationLabelStyle.DrawLabel(canvas, text, new PointF(x, y));
        }
        ...
        void DrawLabelBackground(ICanvas canvas, RectF labelRect)
        {
            ...
            DrawTextBackground(canvas, labelRect, Text, annotationLabelStyle);
        }

        void DrawTextBackground(ICanvas canvas, RectF labelRect, string text, ChartAnnotationLabelStyle labelStyle)
        {
