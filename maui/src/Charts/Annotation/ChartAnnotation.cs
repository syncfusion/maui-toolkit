...
namespace Syncfusion.Maui.Toolkit.Charts
{
    ...
    public abstract class ChartAnnotation : Element
    {
        ...
        internal ChartAnnotationLabelStyle annotationLabelStyle;
        ...
        internal static void OnLabelStylePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is ChartAnnotation annotation)
            {
                ...
                {
                    annotation.annotationLabelStyle = newStyle;
                ...
                {
                    annotation.annotationLabelStyle = new ChartAnnotationLabelStyle();
                    annotation.annotationLabelStyle.Parent = annotation.Parent;
                    SetInheritedBindingContext(annotation.annotationLabelStyle, annotation.BindingContext);
                }
        ...
        void LayoutAnnotation()
        {
            ...
            var axes = Chart.ChartArea;
            var xAxis = GetAxis(axes.XAxes, XAxisName);
            var yAxis = GetAxis(axes.YAxes, YAxisName);
        ...
        ChartAxis? GetAxis(IEnumerable<ChartAxis> axes, string name)
        {
