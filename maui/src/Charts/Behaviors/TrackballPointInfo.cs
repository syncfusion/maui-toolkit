...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	/// </summary>
	public partial class TrackballPointInfo : INotifyPropertyChanged
	{
		#region Fields
		...
		internal void ShowTrackballLabel(SfCartesianChart cartesianChart, Rect bounds)
		{
			...
			if (!cartesianChart.IsTransposed)
			{
				...
				TooltipHelper.PriorityPositionList = [TooltipPosition.Left, TooltipPosition.Bottom, TooltipPosition.Top];
			}
			else
			{
				TooltipHelper.PriorityPosition = TooltipPosition.Top;
				TooltipHelper.PriorityPositionList = [TooltipPosition.Bottom, TooltipPosition.Right, TooltipPosition.Left];
