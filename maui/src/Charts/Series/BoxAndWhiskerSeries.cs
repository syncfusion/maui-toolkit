...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	public class BoxAndWhiskerSeries : XYDataSeries, IDrawCustomLegendIcon
    {
                ...
                foreach (object point in nearestDataPoints)
                {
                    ...
                    if (Segments[index] is BoxAndWhiskerSegment segment)
                    {
                        ...
                        if (chartPointInfo != null)
                        {
                            ...
                            chartPointInfo.YValues = new List<double>() { segment.Maximum, segment.UpperQuartile, segment.Median, segment.LowerQuartile, segment.Minimum };
        ...
        double GetMedianValue(double[] yList)
        {
