...
namespace Syncfusion.Maui.Toolkit.Charts
{
	...
	/// ***
	/// </example>
	public partial class ColumnSeries : XYDataSeries, IDrawCustomLegendIcon, ISBSDependent
	{
		...
		void CreateSegment(SeriesView seriesView, double[] values, int index)
		{
			if (CreateSegment() is ColumnSegment segment)
			{
				...
				{
					if (OldSegments[index] is ColumnSegment oldSegment)
					{
						segment.SetPreviousData([oldSegment.Y1, oldSegment.Y2]);
					}
				}
			}
		}
