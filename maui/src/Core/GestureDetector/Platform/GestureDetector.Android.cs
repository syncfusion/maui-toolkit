    ...
    public partial class GestureDetector
    {
        ...
        class ScrollListener : AGestureDetector.SimpleOnGestureListener
        {
            ...
            public override bool OnFling(MotionEvent? e1, MotionEvent? e2, float velocityX, float velocityY)
            {
                ...
                {
                    Func<double, double> fromPixels = Android.App.Application.Context.FromPixels;
                    this._scrollVelocity = new Point(fromPixels(velocityX), fromPixels(velocityY));
                }
            ...
            {
                GestureDetector?.OnScroll((relativeTo) => TouchDetector.CalculatePosition(e, GestureDetector.MauiView, relativeTo), GestureStatus.Completed, point, Point.Zero, this._scrollVelocity);
                _isScrolling = false;
                this._scrollVelocity = Point.Zero;
            }
