...
namespace Syncfusion.Maui.Toolkit.EffectsView
{
	...
	public partial class SfEffectsView : SfContentView, ITouchListener, ITapGestureListener, ILongPressGestureListener, IParentThemeElement
	{
		#region Fields

		const float AnchorValue = 0.5005f;
		...
		void StartScaleAnimation()
		{
			...
			{
				Content.AnchorX = AnchorValue;
				Content.AnchorY = AnchorValue;
