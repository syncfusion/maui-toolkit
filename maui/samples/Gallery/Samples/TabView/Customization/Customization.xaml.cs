...
namespace Syncfusion.Maui.ControlsGallery.TabView.SfTabView
{
	...
	public partial class Customization : SampleView
	{
		...
		public Customization()
		{
			...
			After:
						SelectedItemColor = ((SolidColorBrush)this.TabView.IndicatorBackground).Color;
						int r = Convert.ToInt32(SelectedItemColor.Red * 255);
						int g = Convert.ToInt32(SelectedItemColor.Green * 255);
						int b = Convert.ToInt32(SelectedItemColor.Blue * 255);
			*/
			TabView.IndicatorBackground = new SolidColorBrush(Colors.RoyalBlue);
			SelectedItemColor = ((SolidColorBrush)TabView.IndicatorBackground).Color;
			int r = Convert.ToInt32(SelectedItemColor.Red * 255);
			int g = Convert.ToInt32(SelectedItemColor.Green * 255);
			int b = Convert.ToInt32(SelectedItemColor.Blue * 255);

			TabView.TabBarBackground = new SolidColorBrush(Color.FromRgba(r, g, b, 25));
		}
		...
		private void SfTabView_SelectionChanged(object sender, Syncfusion.Maui.Toolkit.TabView.TabSelectionChangedEventArgs e)
		{
			...
			SelectedItemColor = ((SolidColorBrush)view.IndicatorBackground).Color;
			int r = Convert.ToInt32(SelectedItemColor.Red * 255);
			int g = Convert.ToInt32(SelectedItemColor.Green * 255);
			int b = Convert.ToInt32(SelectedItemColor.Blue * 255);
