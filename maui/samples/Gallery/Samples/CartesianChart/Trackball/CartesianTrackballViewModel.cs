...
{
	public partial class CartesianTrackballViewModel : BaseViewModel
	{
		public ObservableCollection<ChartDataModel> ChartData1 { get; set; }
		public string[] DisplayMode => ["FloatAllPoints", "NearestPoint", "GroupAllPoints"];
		public string[] TrackballLabel => ["Default", "Template"];
