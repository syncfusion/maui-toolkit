...
{
	internal partial class DynamicAnimationViewModel : BaseViewModel
	{
		ObservableCollection<ChartDataModel> motionAnimation = [];
		ObservableCollection<ChartDataModel> dynamicBubbleMotionAnimation = [];
		ObservableCollection<ChartDataModel> dynamicRangeColumnMotionAnimation = [];
		bool canStopTimer;
		...
		public DynamicAnimationViewModel()
		{
			var r = new Random();
			MotionAnimation = [];
			DynamicBubbleMotionAnimation = [];
			DynamicRangeColumnMotionAnimation = [];
