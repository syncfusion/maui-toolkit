...
{
	public partial class PlotBandViewModel : BaseViewModel
	{
		public string[] PlotBandType => ["Fill", "Line", "Segment"];
		...
		public PlotBandViewModel()
		{
			...
			ClimateData =
			[
				new ChartDataModel() { Date = new DateTime(2023, 01, 15), Name = "Jan", Value = 22.7 },
				new ChartDataModel() { Date = new DateTime(2023, 02, 05), Name = "Feb", Value = 24.5 },
				new ChartDataModel() { Date = new DateTime(2023, 03, 05), Name = "Mar", Value = 26.8 },
				new ChartDataModel() { Date = new DateTime(2023, 04, 05), Name = "Apr", Value = 28.4 },
				new ChartDataModel() { Date = new DateTime(2023, 05, 05), Name = "May", Value = 29.6 },
				new ChartDataModel() { Date = new DateTime(2023, 06, 05), Name = "Jun", Value = 29.2 },
				new ChartDataModel() { Date = new DateTime(2023, 07, 05), Name = "Jul", Value = 27.6 },
				new ChartDataModel() { Date = new DateTime(2023, 08, 05), Name = "Aug", Value = 27.2 },
				new ChartDataModel() { Date = new DateTime(2023, 09, 05), Name = "Sep", Value = 27.3 },
				new ChartDataModel() { Date = new DateTime(2023, 10, 05), Name = "Oct", Value = 28.3 },
				new ChartDataModel() { Date = new DateTime(2023, 11, 05), Name = "Nov", Value = 27.2 },
				new ChartDataModel() { Date = new DateTime(2023, 12, 01), Name = "Dec", Value = 25.2 },
			];

			#region Plot band fill

			NumericalPlotBandFillCollection = [];
			...
			NumericalPlotBandLineCollection = [];
			...
			SegmentPlotBandCollectionWindows = [];
