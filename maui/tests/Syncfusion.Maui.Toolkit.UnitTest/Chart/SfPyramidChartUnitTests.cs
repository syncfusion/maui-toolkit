...
namespace Syncfusion.Maui.Toolkit.UnitTest
{
    public class SfPyramidChartUnitTests
    {
        ...
        public void Stroke_SetAndGet_ReturnsExpectedValue()
        {
            ...
            chart.Stroke = new SolidColorBrush(Colors.Red);
