...
namespace Syncfusion.Maui.Toolkit.UnitTest
{
    public class SfEffectsViewUnitTests : BaseUnitTest
    {
        ...
        {
            SfEffectsView effecstView = new SfEffectsView();
        ...
        public void LongPressEffects_SetValue_ReturnsExpectedValue(SfEffects longPressEffects)
        {
            ...
            effectsView.LongPressEffects = longPressEffects;
        ...
        {
            var effectsView = new SfEffectsView();
            effectsView.TouchDownEffects = touchDownEffects;
        ...
        {
            var effectsView = new SfEffectsView();
            effectsView.TouchUpEffects = touchUpEffects;
        ...
        {
            var effectsView = new SfEffectsView();
            effectsView.IsSelection = isSelection;
        ...
        {
            var effectsView = new SfEffectsView();
            effectsView.LongPressHandled = longPressHandled;
        ...
        {
            var effectsView = new SfEffectsView();
            effectsView.ForceReset = forceReset;
