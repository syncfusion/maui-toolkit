...
{    
    public class SfSegmentedControlUnitTests : BaseUnitTest
    {
        ...
        public void ItemsSource_ResetItems_ReturnsExpectedValue()
        {
            ...
            var itemsSource = new ObservableCollection<string> { "Item1", "Item2", "Item3" };
            segmentedControl.ItemsSource = itemsSource;
            itemsSource = new ObservableCollection<string> { "NewItem1", "NewItem2" };
            segmentedControl.ItemsSource = itemsSource;
            Assert.Equal(2, ((ObservableCollection<string>)segmentedControl.ItemsSource).Count);
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.SegmentHeight = segmentHeight;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.SegmentWidth = segmentWidth;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.VisibleSegmentsCount = visibleSegmentsCount;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.AutoScrollToSelectedSegment = autoScroll;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.StrokeThickness = thickness;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.ShowSeparator = showSeparator;
        ...
        public void SegmentItemWidth_SetValues_ReturnsExpectedValue(double segmentWidth)
        {
            ...
            segmentedControl.Width = segmentWidth;
        ...
        {
            var segmentedControl = new SfSegmentItem();
            segmentedControl.ImageSize = segmentImageSize;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.SegmentHeight = segmentHeight1;
            segmentedControl.SegmentWidth = segmentWidth1;
        ...
        {
            var segmentedControl = new SfSegmentedControl();
            segmentedControl.SegmentCornerRadius = segmentCornerRadius;
            segmentedControl.CornerRadius = cornerRadius;
        ...
        public void ItemsSourceAndVisibleSegmentCountTest(string[] itemsSource, int visibleSegmentCount)
        {
            ...
            control.VisibleSegmentsCount = visibleSegmentCount;
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        public void GetVisibleSegmentsCount_ReturnsExpectedCount(int visibleSegmentsCount, int expectedCount)
        {
            var itemInfo = new SfSegmentedControl
            {
                ...
                Items = new ObservableCollection<SfSegmentItem>
            {
                new SfSegmentItem {},
                new SfSegmentItem {},
                new SfSegmentItem {}
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        public void GetActualSegmentWidth_ReturnsExpectedWidth(double widthRequest, double minWidth, double maxWidth, LayoutAlignment alignment, double expectedResult)
        {
            var segmentInfo = new SfSegmentedControl
            {
                Items = new ObservableCollection<SfSegmentItem> { new SfSegmentItem { } },
        ...
        {
            var segmentInfo = new SfSegmentedControl { Items = new ObservableCollection<SfSegmentItem> { new SfSegmentItem { } }, VisibleSegmentsCount = 1, StrokeThickness = -1 };
            var widthRequest = 100.0;
            var minWidth = 50.0;
            var maxWidth = 200.0;
            var alignment = LayoutAlignment.Fill;
        ...
        {
            var itemInfo = new SfSegmentedControl { Items = new ObservableCollection<SfSegmentItem> { new SfSegmentItem { } } };
        ...
        {
            var itemInfo = new SfSegmentedControl { Items = new ObservableCollection<SfSegmentItem> { new SfSegmentItem {  } }, SegmentHeight = 200 };
            var heightRequest = -100.0;
            var minHeight = 50.0;
            var maxHeight = 100.0;
        ...
        {
            var itemInfo = new SfSegmentedControl { Items = null };
            var resultHeight = SegmentViewHelper.GetActualSegmentHeight(itemInfo, heightRequest, minHeight, maxHeight);
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        public void GetOutlinedBorderRect_ShouldReturnCorrectRect()
        {
            ...
            this.SetPrivateField(segmentView, "_segmentWidth", 50f);
            this.SetPrivateField(segmentView, "_segmentHeight", 40f);
            var result = this.InvokePrivateMethod(segmentView, "GetOutlinedBorderRect", dirtyRect);
        ...
        public void GetTextRect_ShouldReturnCorrectRect_WhenGivenValidInput_DefaultMode()
        {
            ...
            double padding = 5.0;
            var result = this.InvokePrivateMethod(segment, "GetTextRect", dirtyRect, imageRect, padding);
            Assert.NotNull(result);
        ...
        public void GetSegmentLayoutRect_ReturnsCorrectRect_Windows()
        {
            ...
            this.SetPrivateField(segmentView, "_segmentWidth", 10);
            this.SetPrivateField(segmentView, "_segmentHeight", 10);
            var result = this.InvokePrivateMethod(segmentView, "GetSegmentLayoutRect", dirtyRect);
            Assert.NotNull(result);
            var rectResult = (RectF)result!;
        ...
        public void GetKeyboardLayoutRect_ReturnsCorrectRect()
        {
            var segmentView = new SfSegmentedControl();
            var dirtyRect = new RectF(100, 100, 100, 100);
            var result = this.InvokePrivateMethod(segmentView, "GetKeyboardLayoutRect", dirtyRect);
            Assert.NotNull(result);
            var rectResult = (RectF)result!;
        ...
        {
            var segmentView = new SfSegmentItem();
            var itemInfo = new SfSegmentedControl();
            var segmentItem = new SfSegmentItem();
            var segment = new SegmentItemView(itemInfo, segmentItem);
            var dirtyRect = new RectF(100, 100, 100, 100);
        ...
        public void GetRightBorderPosition_ShouldReturnCorrectPosition()
        {
            ...
            var rightBorderPosition = this.InvokePrivateMethod(selection, "GetRightBorderPosition", dirtyRect, strokeThickness);
        ...
        public void GetBottomBorderPosition_ReturnsNaN_WhenDirtyRectIsNull()
        {
            ...
            var selection = new SelectionView(segmentItem, itemInfo);
            var strokeThickness = 5.0f;
            var result = this.InvokePrivateMethod(selection, "GetBottomBorderPosition", null, strokeThickness);
            Assert.NotNull(result);
            var bottomBorderPosition = (float)result;
        ...
        public void GetDefaultString_ReturnsCorrectDefaultString(string text, string expectedResult)
        {
            ...
            var segmentItem = new SfSegmentItem();
            var segment = new SegmentItemView(itemInfo, segmentItem);
            var result = (string)this.InvokeStaticPrivateMethod(resources, "GetDefaultString", text);
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        {
            var itemInfo = new SfSegmentedControl { Items = items };
            var layout = new SegmentLayout(itemInfo);
        ...
        {
            var itemInfo = new SfSegmentedControl { Items = new ObservableCollection<SfSegmentItem> { new SfSegmentItem { } }, CornerRadius = new CornerRadius(10, 20, 30, 40) };
            var layout = new SegmentLayout(itemInfo);
            var resultCornerRadius = InvokePrivateMethod(layout, "GetSegmentCornerRadius", 0);
        ...
        public void GetImageRect_ReturnsCorrectImageRect_WhenTextIsEmpty()
        {
            ...
            var dirtyRect = new RectF(100, 100, 100, 100);
            var result = this.InvokePrivateMethod(segment, "GetImageRect", dirtyRect);
            Assert.NotNull(result);
        ...
        public void GetBackgroundValue_ReturnsTransparent_WhenItemInfoOrSegmentItemIsNull()
        {
            ...
            var resultBrush = this.InvokePrivateMethod(segment, "GetBackgroundValue");
            Assert.NotNull(resultBrush);
        ...
        public void GetBackgroundValue_ReturnsSelectedSegmentBackground_WhenItemSelectedAndNotMouseOver()
        {
            ...
            var result = this.InvokePrivateMethod(segment, "GetBackgroundValue");
            Assert.NotNull(result);
        ...
        public void GetBackgroundValue_ReturnsSelectedSegmentHoveredBackground_WhenItemSelectedAndMouseOver()
        {
            ...
            var segment = new SegmentItemView(segmentControl, segmentItem);
            segment.IsSelected = true;
            this.SetPrivateField(segment, "_isMouseOver", true);
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        {
            var resultWidth = (double)this.InvokeStaticPrivateMethodClass(typeof(SegmentViewHelper), "GetEffectiveWidth", widthRequest, minWidth, maxWidth, visibleSegmentCount, isAlignmentFill);
...
#pragma warning restore CS8604 // Suppress warning for possible null reference argument
        ...
        {
            var segmentControl = new SfSegmentedControl { Items = null };
            var visibleSegmentsCount = 3;
            var resultWidth = (double)InvokeStaticPrivateMethodClass(typeof(SegmentViewHelper), "GetTotalSegmentWidth", segmentControl, visibleSegmentsCount);
            Assert.Equal(0, resultWidth);
        }
